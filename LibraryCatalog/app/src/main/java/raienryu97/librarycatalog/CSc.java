...
public class CSc extends AppCompatActivity{
        ...
        StringRequest stringRequest = new StringRequest(JSON_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CSc.this,error.getMessage(),Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String json){
        ...
        for(i=0;i<10;i++) {
            if (ParseJSON.categories[i].equals("Computer Science")) {
    ...
    public void onBackPressed() {
        Intent main = new Intent(CSc.this,MainActivity.class);
